...
//echo $sql;die;
$res = $db->query($sql);
$total_products = $res->fetch_object()->total_products;



$sql = "SELECT count(id) as total_orders FROM `order`";
$res = $db->query($sql);
$total_orders = $res->fetch_object()->total_orders;

$sql = "SELECT count(id) as total_users FROM `users`";
$res = $db->query($sql);
$total_users = $res->fetch_object()->total_users;
            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Products
                               </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-success shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Orders
                                </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-left-warning shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Earnings
                                </div>
