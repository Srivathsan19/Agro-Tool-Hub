...
$products = Product::find($id, $db);
$image1 = explode('/', $products->image1)[3];
$image2 = explode('/', $products->image2)[3];
$image3 = explode('/', $products->image3)[3];
//print_r($image3);die;
...
try {
    ...
    $product->update($id);
         ...
         if (file_exists('../../uploaded-files/product/' . $image1)) {
                unlink('../../uploaded-files/product/' . $image1);
            }

            if (file_exists('../../uploaded-files/product/' . $image2)) {
                unlink('../../uploaded-files/product/' . $image2);
            }
            if (file_exists('../../uploaded-files/product/' . $image3)) {
                unlink('../../uploaded-files/product/' . $image3);
            }
    ...
    echo json_encode(['msg' => 'failed to update product, please try again ']);
}