                        ...
                        <ul class="main-menu">
                            <li class="">
                                ...
                                <?php if (isset($_SESSION['USER_LOGIN'])) {
                                    echo '<a href="./logout.php">Logout</a> | <a href="./my_orders.php">my_order</a>';
                                } else {
                ...
                <div class="sidebar-gallery w-full p-tb-30">
                    ...
                    <div class="flex-w flex-sb p-t-36 gallery-lb">
                        ...
                        <div class="wrap-item-gallery m-b-10">
                            <a class="item-gallery bg-img1" href="images/download1.jpeg" data-lightbox="gallery"
                                style="background-image: url('images/download1.jpeg');"></a>
                        </div>

                        <!-- item gallery sidebar -->
                        <div class="wrap-item-gallery m-b-10">
                            <a class="item-gallery bg-img1" href="images/download2.jpeg" data-lightbox="gallery"
                                style="background-image: url('images/download2.jpeg');"></a>
                        </div>

                        <!-- item gallery sidebar -->
                        <div class="wrap-item-gallery m-b-10">
                            <a class="item-gallery bg-img1" href="images/download3.jpeg" data-lightbox="gallery"
                                style="background-image: url('images/download3.jpeg');"></a>
                        </div>

                        <!-- item gallery sidebar -->
                        <div class="wrap-item-gallery m-b-10">
                            <a class="item-gallery bg-img1" href="images/download11.jpeg" data-lightbox="gallery"
                                style="background-image: url('images/download11.jpeg');"></a>
                        </div>

                        <!-- item gallery sidebar -->
                        <div class="wrap-item-gallery m-b-10">
                            <a class="item-gallery bg-img1" href="images/download12.jpg" data-lightbox="gallery"
                                style="background-image: url('images/download12.jpg');"></a>
                        </div>

                        <!-- item gallery sidebar -->
                        <div class="wrap-item-gallery m-b-10">
                            <a class="item-gallery bg-img1" href="images/download14.jpg" data-lightbox="gallery"
                                style="background-image: url('images/download14.jpg');"></a>
                        </div>
