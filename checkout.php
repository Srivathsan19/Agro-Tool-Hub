...
value="http://localhost/toolsagro/payment_complete.php" /><input type="hidden" name="furl" 
value="http://localhost/toolsagro/payment_fail.php"/><input type="submit" style="display:none;"/></form>';
        echo $formHtml;
