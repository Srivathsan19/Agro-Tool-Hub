...
if($cat_id>0){
 $products=get_product($db,'',$cat_id);
 }else {
    ?>
    <script>
...
<div class="bg0 m-t-23 p-b-140">
        <div class="container">
                    ...
                    <div class="block2">
                        ...
                        <div class="block2-txt flex-w flex-t p-t-14">
                            <div class="block2-txt-child1 flex-col-l ">
                                <a href="product-details.php?id=<?php echo $product['id'] ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
            ...
            <div class="flex-c-m flex-w w-full p-t-45">
                <a href="categories.php" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04">
                    Load More
                </a>
            </div>
        </div>
